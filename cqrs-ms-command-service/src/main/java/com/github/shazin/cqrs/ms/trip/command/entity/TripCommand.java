package com.github.shazin.cqrs.ms.trip.command.entity;
...
public class TripCommand {
    ...
    public TripCommand(String id, String payload, Date createdDate, String createdBy, String type) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        TripCommand that = (TripCommand) o;
