package com.github.shazin.cqrs.ms.assignment.command.entity;
...
@Entity
@Table(name = "cqrs_assignment_command")
public class AssignmentCommand {
    ...
    public AssignmentCommand(String id, String payload, Date createdDate, String createdBy, String type) {
        this.id = id;
